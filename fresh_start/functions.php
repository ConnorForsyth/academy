<?php
/**
 * fresh_start functions and definitions
 *
...
if ( ! function_exists( 'fresh_start_setup' ) ) :
	...
	function fresh_start_setup() {
		 ...
		 * If you're building a theme based on fresh_start, use a find and replace
		 * to change 'fresh_start' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'fresh_start', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'fresh_start' ),
		) );
...
function fresh_start_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'fresh_start' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'fresh_start' ),
...
function fresh_start_scripts() {
	...
	wp_enqueue_style( 'fresh_start-style', get_stylesheet_uri() );

	/*Shown by tutorial - This loads bootstrap when the page is loaded */
	...
	wp_enqueue_script( 'fresh_start-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'fresh_start-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
